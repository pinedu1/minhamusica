...
describe( 'NotaAbc', () => {
  ...
  describe( 'toAbc', () => {
    it( 'deve exportar para ""G"g2"', () => {
      ...
      const nota = ObjectFactory.newNota( altura, duracao, { acordes: [ 'G' ], unidadeTempo: new TempoDuracao( 1, 1 ) } );
	  ...
	  it( 'deve exportar para "_e2"', () => {
		  ...
		  const duracao = new TempoDuracao( 2, 1 );
		  const nota = ObjectFactory.newNota( altura, duracao, { unidadeTempo: new TempoDuracao( 1, 1 ) } );
		  const abcString = NotaAbc.toAbc( nota );
    ...
    it( 'deve exportar para ""D7"B"', () => {
      ...
      const nota = ObjectFactory.newNota( altura, duracao, { acordes: [ 'D7' ], unidadeTempo: new TempoDuracao( 1, 1 ) } );
	  const abcString = NotaAbc.toAbc( nota );
    ...
    it( 'deve exportar para ""C"~c"', () => {
      ...
      const duracao = new TempoDuracao( 1, 1 );
      const nota = ObjectFactory.newNota( altura, duracao, { acordes: [ 'C' ], roll: true, unidadeTempo: new TempoDuracao( 1, 1 ) } );
