  ...
  describe( 'fromJson', () => {
    it( 'deve criar uma quialtera a partir de um JSON completo', () => {
	    const json = {
			id: 0,
		    notas: [
			    { id: 0, tipo: 'nota', altura: { key: 'C4' }, duracao: { duracao: '1/16' } },
			    { id: 0, tipo: 'nota', altura: { key: 'D4' }, duracao: { duracao: '1/16' } },
			    { id: 0, tipo: 'nota', altura: { key: 'E4' }, duracao: { duracao: '1/16' } },
		    ],
		    duracao: { duracao: '1/4' },
		    options: {
			    acordes: [ 'C' ],
    ...
    it( 'deve criar uma quialtera a partir de um JSON mínimo', () => {
      const json = {
		  id: 0,
	      notas: [
		      { id: 0, tipo: 'nota', altura: { key: 'C4' }, duracao: { duracao: '1/12' } },
		      { id: 0, tipo: 'nota', altura: { key: 'D4' }, duracao: { duracao: '1/12' } },
		      { id: 0, tipo: 'nota', altura: { key: 'E4' }, duracao: { duracao: '1/12' } },
	      ],
	      duracao: { duracao: '1/4' },
      };
      const quialtera = QuialteraJson.fromJson( json );
  ...
  describe( 'toJson', () => {
	  it( 'deve exportar para um JSON completo', () => {
		  ...
		  expect( parsed ).toEqual( {
			  ...
			  tipo: 'quialtera',
			  notas: [
				  { id: 0, tipo: 'nota', altura: 'C4', duracao: '1/12', options: {} },
				  { id: 0, tipo: 'nota', altura: 'D4', duracao: '1/12', options: {} },
				  { id: 0, tipo: 'nota', altura: 'E4', duracao: '1/12', options: {} },
			  ],
			  duracao: '1/4',
			  options: {
				  acordes: [ 'C' ],
